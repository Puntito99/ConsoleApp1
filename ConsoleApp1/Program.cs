...
class Program
{
    ...
    public static void agregarEstudiante()
    {
        ...
        Console.WriteLine("Codigo: "+ std.StudentId + " Nombre: "+ std.Nombre + " Apellido: " + std.Apellido); " Direccion: " + std.Direccion); " Telefono: " + std.Telefono); "FechaNac: " + std.FechaNac); " Estado: " + std.Estado);

    }

    public static void consultarEstudiantes()" Nombre: "+ std.Nombre
    {
